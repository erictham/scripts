...
#                analyse_nodes[i[u'subjectUris'][0]] ={'label':i[u'label'],'country':i[u'isDomiciledIn_attr']}
#            else:
#                #analyse_nodes[i[u'subjectUris'][0]] ={'index':j, 'label':i[u'label'],'country':'others'}
#                analyse_nodes[i[u'subjectUris'][0]] ={'label':i[u'label'],'country':'others'}
#            if u'scbLEID_attr' in i.keys():
#                analyse_nodes[i[u'subjectUris'][0]]["scbLEID_attr"] = i["scbLEID_attr"]
#            else:
#                analyse_nodes[i[u'subjectUris'][0]]["scbLEID_attr"] = "ntb"
            fieldlist=[i[u'label']]
            if u'isDomiciledIn_attr' in i.keys(): fieldlist.append(i[u'isDomiciledIn_attr']) 
            else: fieldlist.append('Others')
            if u'hasURL_attr' in i.keys(): fieldlist.append(i[u'hasURL_attr']) 
